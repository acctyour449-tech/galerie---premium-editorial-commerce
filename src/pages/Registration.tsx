      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
          ...
          <div className="relative py-4 flex items-center justify-center">
            ...
            <span className="relative z-10 px-4 bg-surface-container-lowest text-[9px] text-on-surface-variant font-black uppercase tracking-[0.2em] opacity-40">Or register with</span>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <button 
              type="button" 
              onClick={() => { register('Social User', 'google@example.com', role); navigate(role === 'seller' ? '/seller' : '/profile'); }}
            ...
            <button 
              type="button" 
              onClick={() => { register('Social User', 'apple@example.com', role); navigate(role === 'seller' ? '/seller' : '/profile'); }}
              className="flex items-center justify-center gap-3 py-4 border border-black/5 rounded-xl hover:bg-surface-container-low transition-all group"
            >
